...
public class PointyRightMonitor extends AbsPointyMonitor {
    private static String TAG = "PointyRightMonitor";
    ...
    public PointyRightMonitor(CanvasEventMonitor canvasEventMonitor) {
    ...
    public BleSpenGestureType whoAmI() {
        return BleSpenGestureType.POINTY_RIGHT;
    }

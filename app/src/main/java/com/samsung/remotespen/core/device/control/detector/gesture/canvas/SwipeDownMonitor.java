...
public class SwipeDownMonitor extends AbsSwipeMonitor {
    ...
    public SwipeDownMonitor(CanvasEventMonitor canvasEventMonitor) {
    ...
    public boolean isMovedTooFarAway(Event event) {
        ...
        return rawEventHistoryManager != null && Math.abs(rawEventHistoryManager.getPositionX()) > 300.0f && event.absDeltaX >= event.absDeltaY;
    }
